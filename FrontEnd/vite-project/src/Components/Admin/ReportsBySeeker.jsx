...
const ReportsBySeeker = () => {
  ...
  const handleResolve = async (id) => {
    try {
      await axios.put(`http://localhost:5000/api/reports/${id}`, { status: 'resolved', replyMessage });
  ...
  return (
    <div>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Reports by Job Seekers</h2>
...
export default ReportsBySeeker;