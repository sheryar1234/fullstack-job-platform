...
const RecruiterSignup = () => {
  ...
  const handleRecruiterSignup = async (e) => {
    ...
    console.log({ firstName, lastName, cnic, email, password });
    try {
      const response = await axios.post('http://localhost:5000/api/auth/recruiter-signup', {
       email,
      password,
      firstName,
      lastName,
                ...
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="">
                    <div className="mt-3 text-center text-sm dark:text-gray-700">
                      ...
                      <a className="text-cyan-500 underline hover:text-cyan-400 ml-1" href="/recruiter-login">
                        Log In here
                      </a>
                    </div>
                  </div>
